var language={
	...
	zh:{
		...
		operation:"<li><font class='opt'>設置符號</font>點選<font class='mus'>棋盤上的任何方塊</font>或按<font class='key'>A-I鍵</font></li><li><font class='opt'>清除棋盤</font>點選<font class='mus'>Clean</font>或按<font class='key'>Del鍵</font></li><li><font class='opt'>回上一步</font>點選<font class='mus'>Undo</font>或按<font class='key'>Ctrl+Z鍵</font></li><li><font class='opt'>回下一步</font>按<font class='key'>Ctrl+Y鍵</font></li><li><font class='opt'>使用更多功能</font>就從<font class='mus'>Clean</font>喚出清單或按<font class='key'>Alt鍵</font></li><li><font class='opt'>以網址記錄棋盤</font>就從<font class='mus'>棋盤</font>喚出清單</li><li><font class='opt'>顯示快速選單</font>移動滑鼠到<font class='mus'>左側空白處</font></li>",
		operationT:"試試這些基本操作：",
		Rule:"遊戲規則",
