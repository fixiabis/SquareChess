...
Rls.Connect=function(r){var jdg=1
	...
	r=Rls.add(r,Rls.Dir[0]);r=Rls.add(r,"符號須設置於我方符號周圍")
	r=Rls.add(r,Rls.Jdg[jdg]);r=Rls.add(r,Rls.Dir[1]);return r
}
...
Rls.Divider=function(r){var jdg=1
	r=Rls.ext(r,Rls.Set[0],Rls.Set[1])
	if(Rls.dft)jdg=Dft.Divider.QJd;r=Rls.add(r,Rls.Dir[0])
...
Rls.Adapter=function(r){var jdg=1
	r=Rls.ext(r,Rls.Set[0],Rls.Set[1])
	if(Rls.dft)jdg=Dft.Adapter.QJd;r=Rls.add(r,Rls.Dir[0])
