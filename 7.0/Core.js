var Turn=0,Dft={Clr:1,Blk:0,Dir:""},Sbl=["O","X",""],Sqr=[[" ","","dimgray"]],cd8="F,B,R,L,FR,FL,BR,BL".split(","),Hst={Brd:[],Crd:[]}
...
function Adn(){bdB()}
function Set(c){if(!Lmt(c)){Hst.Crd[Turn+1]=c;Id(c).innerHTML=Sbl[Turn%2];Turn++}Wtr();Rul()}
function Wtr(){var b=""
	for(cd1=65;cd1<74;cd1++){
