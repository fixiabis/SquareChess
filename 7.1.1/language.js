var language={
	en:{
		...
		SBRule:"<li>By symbol set at four points form a rectangle,square in the rectangle will become to our area.</li><li>You can't set the symbol in opposite side's area.</li><li>If the space of chessboard is more than half of your area,then you win.</li>",
		SBBRule:"<li>Inherit Square.Blocker's Rule</li><li>By symbol set at two points form a line,square in the line will become to our area.</li>",
		...
		SDFRule:"<li>Inherit Square.Divider's Rule</li><li>Each turn just set symbol by connect last turn symbol.</li>",
	...
	zh:{
		...
		SBRule:"<li>符號設置於四點形成矩形，矩形中將變成我方區域</li><li>你不能設置符號於對方的區域中</li><li>當你形成的區域超過場上空白處一半以上時，那你就贏了</li>",
		SBBRule:"<li>延用Square.Blocker的規則</li><li>符號設置於兩點形成矩形，直線中將變成我方區域</li>",
		...
		SDFRule:"<li>延用Square.Divider的規則</li><li>每一回合只能藉由上一回和我方符號所設置的符號連線</li>",
		FRule:"可隨意設置符號",
		Report:"回報問題",
		facebook:"給個讚吧",
		twitter:"跟隨我們",
		RPT:"<form id='RForm'><input type='text' id='Title' placeholder='輸入標題' class='txt'/><br /><textarea rows='5' class='txt' id='Content' placeholder='簡短說明你遇到的問題'></textarea><div class='btn' id='Submit' onClick='Send()'>確認</div></form>",
		RPP:"回報問題"
	}
}
